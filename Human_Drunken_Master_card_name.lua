...
cardNames = {
  "Attack Modifier (null)(shuffle) +(target) rolling (target a figure adjacent to the target)",
  ...
  "Attack Modifier (-1) muddle rolling",
  "Attack Modifier (-1) muddle rolling",
  "Attack Modifier (-2) ((icon): (attack)4)",
  "Attack Modifier (+0) ((heal) 1, (target)(icon))",
  "Attack Modifier (+0) ((heal) 1, (target)(icon))",
  "Attack Modifier (+0) ((heal) 1, (target)(icon))",
  "Attack Modifier (+0) ((heal) 1, (target)(icon))",
  "Attack Modifier one(-1) (If(icon)attacks: target suffers 1(damage) per modifier drawn.)",
  "Attack Modifier one(-1) (If(icon)attacks: target suffers 1(damage) per modifier drawn.)",
  "Attack Modifier (-2) ((+2) If(icon)attacks instead)",
  "Attack Modifier (-1)(wound,self) rolling",
  "Attack Modifier (-1)(wound,self) rolling",
}
cardDescriptions = {
  "Drunken Master",
