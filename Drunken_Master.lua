masteryPos = {
  --[] At the end of each turn have poison muddle .
  [1] = {x=-0.6783199077801642, y=0.11, z=0.6849308476551748},
  --[] Each turn Stumble into at least one figure.
  [2] = {x=-0.6783199077801642, y=0.11, z=0.8149261005883568},
}
perkPos = {
  --[] Remove one [+2] card
  [1] = {x=0.16309059204890017, y=0.11, z=-0.6450742972405725},
  --[|] Replace one [null] [shuffle] card with one rolling [null] [shuffle] card
  [2] = {x=0.16309059204890017, y=0.11, z=-0.5928260261835948},
  [3] = {x=0.16309059204890017, y=0.11, z=-0.5641578709015994},
  --[] Replace one [-2] card with two rolling [-1] cards
  [4] = {x=0.16309059204890017, y=0.11, z=-0.4883293765483072},
  --[||] Replace five [-1] card with five rolling [-1] cards
  [5] = {x=0.16309059204890017, y=0.11, z=-0.3838327269130195},
  [6] = {x=0.16309059204890017, y=0.11, z=-0.3551645716310241},
  [7] = {x=0.16309059204890017, y=0.11, z=-0.3264964163490287},
  --[][] Replace two [+0] cards with one [-2] [retaliate] 2 self card
  [8] = {x=0.16309059204890017, y=0.11, z=-0.2793360772777319},
  [9] = {x=0.20778535357338698, y=0.11, z=-0.2793360772777319},
  --[][] Replace one [+0] card with one [-2] If [icon]attacks: target suffers 1[damage] for each modifier drawn card
  [10] = {x=0.16309059204890017, y=0.11, z=-0.17483942764244423},
  [11] = {x=0.20778535357338698, y=0.11, z=-0.17483942764244423},
  --[][] Replace two [+1] cards with two [+0] muddle cards
  [12] = {x=0.16309059204890017, y=0.11, z=0.032652551266171254},
  [13] = {x=0.20778535357338698, y=0.11, z=0.032652551266171254},
  --[] Add one [+0] +[target] !target a random figure adjacent to the target card
  [14] = {x=0.16309059204890017, y=0.11, z=0.13714920090145874},
  --[] Add three rolling curse cards
  [15] = {x=0.16309059204890017, y=0.11, z=0.24014442265345434},
  --[] You may ignore item [-1card] effects and enemies with muddle attacking you do not ignore rolling modifiers.
  [16] = {x=0.16309059204890017, y=0.11, z=0.2923928012317645},
