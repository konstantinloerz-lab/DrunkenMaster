...
perkPos = {
  --[||] Replace one [null] [shuffle] card with one [null] [shuffle] +[target] rolling "!target a figure adjacent to the target closest to you" card
  ...
  --[] Replace one [-2] card and one [+2] card with two [-1] rolling cards
  [4] = {x=0.1631076239224139, y=0.11, z=-0.43859211739926485},
  --[|] Replace five [-1] cards with five [-1] rolling cards
  [5] = {x=0.1631076239224139, y=0.11, z=-0.3335825497996998},
  [6] = {x=0.1631076239224139, y=0.11, z=-0.3049097992609068},
  --[][] Replace two [+0] card with one [-1] [retaliate] 2 self card
  [7] = {x=0.1631076239224139, y=0.11, z=-0.22857298220013492},
  [8] = {x=0.20780051185344822, y=0.11, z=-0.22857298220013492},
  --[][] Replace one [+0] card with one [-2] "If[icon]attacks: target suffers 1[damage] per modifier drawn" card
  [9] = {x=0.1631076239224139, y=0.11, z=-0.12356341460056988},
  [10] = {x=0.20780051185344822, y=0.11, z=-0.12356341460056988},
  --[][] Replace two [+1] cards with two [+0] [heal] 1, self,poison,muddle cards
  [11] = {x=0.1631076239224139, y=0.11, z=0.08469363031896579},
  [12] = {x=0.20780051185344822, y=0.11, z=0.08469363031896579},
  --[] _ Add one [+0] [icon]: [attack]4 card
  [13] = {x=0.1631076239224139, y=0.11, z=0.18970319791853082},
  --[] Add three [+0] pierce 3 rolling cards
  [14] = {x=0.1631076239224139, y=0.11, z=0.24220798171831334},
  --[] You may ignore item [-1card] effects and enemies with muddle attacking you do not ignore rolling modifiers.
  [15] = {x=0.1631076239224139, y=0.11, z=0.2947127655180959},
