...
cardNames = {
  "Attack Modifier (null) (shuffle) +(target) rolling (!target a figure adjacent to the target closest to you)",
  "Attack Modifier (-1) rolling",
  "Attack Modifier (-1) rolling",
  "Attack Modifier (-1) rolling",
  "Attack Modifier (-1) rolling",
  "Attack Modifier (-1) rolling",
  "Attack Modifier (-1) rolling",
  "Attack Modifier (-1) rolling",
  "Attack Modifier (-1) (retaliate) 2 self",
  "Attack Modifier (-1) (retaliate) 2 self",
  "Attack Modifier (-2) (If(icon)attacks: target suffers 1(damage) per modifier drawn)",
  "Attack Modifier (-2) (If(icon)attacks: target suffers 1(damage) per modifier drawn)",
  "Attack Modifier (+0) (heal) 1, self,poison,muddle",
  "Attack Modifier (+0) (heal) 1, self,poison,muddle",
  "Attack Modifier (+0) (heal) 1, self,poison,muddle",
  "Attack Modifier (+0) (heal) 1, self,poison,muddle",
  "Attack Modifier (+0) pierce 3 rolling",
  "Attack Modifier (+0) pierce 3 rolling",
  "Attack Modifier (+0) pierce 3 rolling",
}
cardDescriptions = {
