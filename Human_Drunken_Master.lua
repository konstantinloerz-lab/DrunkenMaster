masteryPos = {
  --[] At the end of each turn have muddle.
  [1] = {x=-0.678323275862069, y=0.11, z=0.6849331644663483},
  --[] Each turn [icon3] into at least one figure.
  [2] = {x=-0.678323275862069, y=0.11, z=0.8149423879076554},
}
perkPos = {
  --[||] Replace one [null][shuffle] card with one [null][shuffle] +[target] rolling "target a figure adjacent to the target" card
  [1] = {x=0.1631076239224139, y=0.11, z=-0.6450870720392065},
  [2] = {x=0.1631076239224139, y=0.11, z=-0.6164143215004133},
  [3] = {x=0.1631076239224139, y=0.11, z=-0.5877415709616203},
  --[] Replace one [-2] card with two [-1] muddle rolling cards
  [4] = {x=0.1631076239224139, y=0.11, z=-0.4893348109194532},
  --[][] Replace two [-1] cards with two [-1] muddle rolling cards
  [5] = {x=0.1631076239224139, y=0.11, z=-0.38432524331988815},
  [6] = {x=0.20780051185344822, y=0.11, z=-0.38432524331988815},
  --[|] Replace one [-1] card with one [-2] "[icon]: [attack]4" card
  [7] = {x=0.1631076239224139, y=0.11, z=-0.27931567572032323},
  [8] = {x=0.1631076239224139, y=0.11, z=-0.2506429251815302},
  --[][] Replace two [+0] cards with two [+0] "[heal] 1, [target][icon]" cards
  [9] = {x=0.1631076239224139, y=0.11, z=-0.17430610812075822},
  [10] = {x=0.20780051185344822, y=0.11, z=-0.17430610812075822},
  --[][] Replace one [+0] card with one[-1] "If[icon]attacks: target suffers 1[damage] per modifier drawn." card
  [11] = {x=0.1631076239224139, y=0.11, z=-0.0692965405211933},
  [12] = {x=0.20780051185344822, y=0.11, z=-0.0692965405211933},
  --[] Replace one [+2] card with one [-2] "[+2] If[icon]attacks instead" card
  [13] = {x=0.1631076239224139, y=0.11, z=0.1389605043983426},
  --[][] Add one [-1]"wound,self" rolling card
  [14] = {x=0.1631076239224139, y=0.11, z=0.2947127655180959},
  [15] = {x=0.20780051185344822, y=0.11, z=0.2947127655180959},
  --[] You may ignore item [-1card] effects and enemies attacking you can not ignore rolling modifiers.
  [16] = {x=0.1631076239224139, y=0.11, z=0.3472175493178784},
